...
/// actually enables — never a hardcoded individual/team/viewer list, since
/// the backend is genuinely config-driven here. Providers watched and the
/// navigation branch (team → create-team flow, everything else →
/// registration form) are unchanged.
