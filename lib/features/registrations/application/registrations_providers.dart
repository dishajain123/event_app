...
final myRegistrationsProvider = FutureProvider<List<AppRegistration>>((ref) async {
  final repository = ref.watch(registrationsRepositoryProvider);
  return repository.listMyRegistrations();
});

final registrationDetailProvider = FutureProvider.family<AppRegistration, String>((ref, registrationId) async {
  final repository = ref.watch(registrationsRepositoryProvider);
