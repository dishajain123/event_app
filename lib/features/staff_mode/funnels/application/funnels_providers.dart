...
final competitionStagesProvider = FutureProvider.family<List<CompetitionStage>, String>((ref, eventId) async {
  final repository = ref.watch(funnelsRepositoryProvider);
  return repository.listStages(eventId);
});

final publicVoteEntriesProvider = FutureProvider.family<List<FunnelEntry>, String>((ref, stageId) async {
  final repository = ref.watch(funnelsRepositoryProvider);
